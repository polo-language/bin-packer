...
class FeasibleSet {
  ...
  makeFeasibleChildren(sizeOf, capacity) {
    ...
    // Note the final element being excluded as part of an included/excluded
    // pair is equivalent to no more elements being included from the
    // perspective of the excluded child.
